...
class PartyWrittenRequestTest extends TestCase
{
    ...
    public function testSave()
    {
        ...
        $productionIdeaInfo = new ProductionIdeaInfo("OICをRPG化", new ProductionType("システム"), "制作物備考");
    ...
    public function testFindById()
    {
        ...
        $applicantId = new StudentNumber("B1111");
        $activityEndDate = new ActivityEndDate('1431670515');
        $productionIdeaInfo = new ProductionIdeaInfo("OICをRPG化", new ProductionType("システム"), "制作物備考1");
        $wantedRoleInfoList[] = new WantedRoleInfo("Laravelエンジニア", "やれるやつ", "abcd",2);
        ...
        $productionIdeaInfo2 = new ProductionIdeaInfo("Unityでげーむ", new ProductionType("ゲーム"), "制作物備考2");
